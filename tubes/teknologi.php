              ...
              <div class="row">
                  ...
                  <div class="card mb-3">
                      ...
                      <div class="card-body">
                        ...
                        <p class="card-text">PORTALJABAR, KAB. GARUT - Biro Perencanaan Kementerian Komunikasi dan Informatika (Kominfo) RI bekerja sama dengan Pemda Provinsi Jabar menggelar acara workshop prototype pengembangan desa digital yang dilaksanakan di Ballroom Hotel Santika, Jalan Cipanas Baru, Kecamatan Tarogong Kaler, Kabupaten Garut (9/3/2023).
                            ...
                            Kepala Biro Perencanaan Kominfo RI, Arifin Saleh Lubis, menyampaikan bahwa kegiatan ini merupakan tindak lanjut dari kegiatan yang dilaksanakan sebelumnya.

                            Arifin mengungkapkan pada kegiatan sebelumnya peserta diberi pengetahuan terkait dasar-dasar teori, sementara untuk saat ini diberikan peningkatan kapasitas salah satunya yaitu pelatihan setting router atau wifi.

                            “Di pelatihan sebelumnya kita melakukan pelatihan untuk dasar-dasar teoritis, nah yang ini sekarang adalah mereka mendapatkan pelatihan bagaimana mensetting perangkat yang dimaksud, dan yang terakhir adalah ujian. Jadi ujian itu nanti bahasa Inggris, dan mungkin mudah-mudahan sederhana gitu bahasa Inggris-nya, dan nanti akan mendapatkan sertifikat internasional,” ucap Arifin.
                        ...
                        <p class="card-text"><small class="text-body-secondary">Kamis, 9 Maret 2023</small></p>
                  ...
                  <div class="card mb-3">
                      ...
                      <div class="card-body">
                        ...
                        Hal tersebut disampaikan Iwan Setiawan saat menghadiri Workshop Penginputan Rencana Umum Pengadaan Pada Aplikasi SIRUP, lingkup Pemerintah Kabupaten Bogor Tahun 2023, yang dilaksanakan di Hotel Lorin Sentul, Kamis (23/2/2023).
                        ...
                        "Diharapkan melalui workshop ini capaian persentase penginputan RUP Kabupaten Bogor bisa mencapai minimal sebesar 80 persen  sehingga menjadi tolak ukur yang baik untuk proses pengadaan selanjutnya," pungkasnya. (Diskominfo Kab. Bogor/Fauziah Ismi)
                      </p>
                        <p class="card-text"><small class="text-body-secondary">Jumat, 24 Februari 2023</small></p>
