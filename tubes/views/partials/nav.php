<nav class="navbar bg-light shadow sm  navbar-expand-lg fixed-top " style="background-image: linear-gradient(to right, rgba(255,0,0,0), rgba(35, 139, 14));">
  <div class="container-fluid ms-3">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link nav-link fw-bold <?= uriIs('berita2.php'); ?>" href="berita2.php">berita2</a>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link fw-bold dropdown-toggle <?= uriIs('berita.php'); ?> <?= uriIs('p_ekonomi.php'); ?> <?= uriIs('p_pemerintahan.php'); ?> <?= uriIs('p_teknologi.php'); ?>  <?= uriIs('p_kesehatan.php'); ?> <?= uriIs('p_sosial.php'); ?> <?= uriIs('p_pendidikan .php'); ?>  " href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Berita
          </a>
